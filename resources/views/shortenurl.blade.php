...
<body>
    ...
    <h1 class="text-4xl font-bold text-center pt-8"> Welcome to URL Shortener</h1>
    ...
    <div class="flex flex-col justify-center items-center box-content">
        <button class=" text-center text-white font-semibold rounded-full py-2 px-4 bg-sky-500 hover:bg-sky-600 active:bg-sky-800 focus:outline-none focus:ring focus:ring-sky-300 hover:text-slate-300"> Copy!</button>
    </div>
</body>
